...
export const ALL_TOOLS: Tool[] = [
  ...
  { id: 'pdf-to-pptx',   name: 'PDF إلى PowerPoint',  description: 'حوّل PDF إلى عرض تقديمي.',                 iconSet: 'MaterialCommunityIcons', iconName: 'microsoft-powerpoint',         category: 'convert' },
  ...
  { id: 'pdf-a',         name: 'PDF/A أرشفة',          description: 'حوّل PDF لصيغة الأرشفة الدولية.',          iconSet: 'MaterialCommunityIcons', iconName: 'archive-arrow-down-outline',             category: 'convert' },
  { id: 'html-to-pdf',   name: 'HTML إلى PDF',         description: 'حوّل صفحات الويب إلى PDF.',                iconSet: 'MaterialCommunityIcons', iconName: 'web-box',                         category: 'convert' },
  { id: 'translate-pdf', name: 'ترجمة PDF',            description: 'ترجم محتوى PDF بالذكاء الاصطناعي.',        iconSet: 'MaterialCommunityIcons', iconName: 'google-translate',                   category: 'ai' },
  ...
  { id: 'zakat',         name: 'حاسبة الزكاة',         description: 'احسب زكاة مالك بسهولة.',                   iconSet: 'MaterialCommunityIcons', iconName: 'star-circle-outline',               category: 'business' },
  { id: 'support',       name: 'الدعم الفني',          description: 'أرسل بلاغ دعم فني مع صورة.',               iconSet: 'MaterialCommunityIcons', iconName: 'headphones',                     category: 'business' },
